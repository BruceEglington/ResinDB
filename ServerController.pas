...
begin
  ...
  ResinDBPath := 'bromo2.usask.ca:s:/Data/Firebird/ResinDB2021v30.fdb';
  ...
  try
    ...
    ResinDBPath := AppIni.ReadString('Paths','ResinDB path','bromo2.usask.ca:s:/Data/Firebird/ResinDB2011v25.fdb');
  ...
  dmR.sqlcResinDB.Params.Append('DevartInterBase TransIsolation=ReadCommitted');
  dmR.sqlcResinDB.Params.Append('WaitOnLocks=True');
  dmR.sqlcResinDB.Params.Append('CharLength=1');
  dmR.sqlcResinDB.Params.Append('EnableBCD=True');
  dmR.sqlcResinDB.Params.Append('OptimizedNumerics=False');
  dmR.sqlcResinDB.Params.Append('LongStrings=True');
  dmR.sqlcResinDB.Params.Append('UseQuoteChar=False');
  dmR.sqlcResinDB.Params.Append('FetchAll=False');
  dmR.sqlcResinDB.Params.Append('UseUnicode=False');
